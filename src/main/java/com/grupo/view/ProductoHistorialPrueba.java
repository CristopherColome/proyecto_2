 ...
 * @author ccolome
 */
public class ProductoHistorialPrueba extends javax.swing.JFrame {

    /**
     * Creates new form productoH
     */
    public ProductoHistorialPrueba() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ProductoHistorialPrueba.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ProductoHistorialPrueba().setVisible(true);
            }
        });
    }
